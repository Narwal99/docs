---
title: 'gpt-5.4'
description: 'Use gpt-5.4 through AI Gateway with an OpenAI-compatible chat completions API.'
---

`gpt-5.4` is available through the OpenAI-compatible chat completions API. It is suitable for chat, reasoning, writing, coding assistance, and tool-oriented application workflows.
