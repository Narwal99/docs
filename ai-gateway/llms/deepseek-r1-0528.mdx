...
description: 'Use DeepSeek-R1-0528 through AI Gateway with an OpenAI-compatible chat completions API.'
---

`DeepSeek-R1-0528` is available through the OpenAI-compatible chat completions API. It is suitable for reasoning-heavy tasks, problem solving, coding assistance, and step-by-step analysis.
...
curl --location --request POST "https://api.gpuhub.com/api/v1/chat/completions" \
  ...
  --data-raw '{
    ...
    "messages": [
      {
        "role": "user",
        "content": "Hello! Please solve this reasoning problem step by step."
      }
    ],
    "stream": true
  }'
...
stream = client.chat.completions.create(
    model="DeepSeek-R1-0528",
    messages=[
        {"role": "user", "content": "Hello! Please solve this reasoning problem step by step."}
    ],
    stream=True,
)
