...
description: 'GPUhub Serverless GPU API: A simple, token-authenticated REST API that lets any user programmatically create, scale, monitor, and manage pay-per-second GPU containers for AI/ML workloads.'
---
...
```
POST /api-reference/api-serverless#request
```
