...
<Warning>
Note: API operations are not supported for on-demand GPU instances. All API features are designed for Elastic Deployment only.
</Warning>
...
url = "https://api.gpuhub.com/api/v1/dev/image/private/list"
body = {
    "page_index": 1,
    "page_size": 10,
}
...
| `cmd_before_shutdown`               | String       | No        | Command executed before container stops (5-second timeout; forced stop on timeout) |
 ...
 ```json Request Body
 {
  ...
  "container_template": {
    "dc_list": ["Singpore-A", "Singapore-B"],
...
| `data_center`     | String  | Region / data center code (e.g., `Singpore-A`)                     |
    ...
    "list": [
      {
        ...
        "price": 1600,
        "info": {
          "ssh_command": "ssh -p 22345 root@singpore-a.gpuhub.com",
          "root_password": "xxxxxxxxxx",
          "service_6006_port_url": "https://singpore-a.gpuhub.com:22346",
          "service_6008_port_url": "http://singpore-a.gpuhub.com:22348"
        },
...
| `dc_list`  | String | Regions covered by the package (comma-separated if multiple, e.g., `singpore-a,singapore-b`) |
...
| ------------------- | --------------- | ----------------- |
| Singapore-B | `Singpore-A`   | `Singpore-A`     |
| Singapore-A | `Singapore-B`   | `Singapore-B`     |



### Public Image UUID

| Framework  | Framework Version | Image UUID              | Description                      |
| ---------- | ----------------- | ----------------------- | -------------------------------- |
| PyTorch    | 2.8.0 (Blackwell) | `base-image-ec1e9vdbd3` | CUDA 12.8 · Ubuntu 22.04         |
| PyTorch    | 2.7.0             | `base-image-d13e3vu5d3` | CUDA 12.8 · Ubuntu 22.04         |
| PyTorch    | 2.5.1             | `base-image-b2343du52k` | CUDA 12.4 · Ubuntu 22.04         |
| PyTorch    | 2.5.1             | `base-image-c1333ve5d3` | CUDA 8.1.rc1 · Ubuntu 22.04      |
| PyTorch    | 2.3.0             | `base-image-321232d5d4` | CUDA 12.1 · Ubuntu 22.04         |
| PyTorch    | 2.1.2             | `base-image-lbdbb183fk` | CUDA 11.8 · Ubuntu 22.04         |
| PyTorch    | 2.1.0             | `base-image-323d32u534` | CUDA 12.1 · Ubuntu 22.04         |
| PyTorch    | 2.1.0             | `base-image-pi743du52k` | CUDA 8.0 · Ubuntu 22.04          |
| PyTorch    | 2.0.0             | `base-image-l2t43iu6uk` | CUDA 11.8 · Ubuntu 20.04         |
| PyTorch    | 1.11.0            | `base-image-l374uiucui` | CUDA 11.3 · Ubuntu 20.04         |
| PyTorch    | 1.10.0            | `base-image-tbk3g58lhs` | CUDA 11.3 · Ubuntu 20.04         |
| PyTorch    | 1.9.0             | `base-image-12be412037` | CUDA 11.1 · Ubuntu 18.04         |
| PyTorch    | 1.8.1             | `base-image-db83412037` | CUDA 11.1 · Ubuntu 18.04         |
| PyTorch    | 1.7.0             | `base-image-db8346e037` | CUDA 11 · Ubuntu 18.04           |
| PyTorch    | 1.6.0             | `base-image-ldnbxc4by8` | CUDA 10.1 · Ubuntu 18.04         |
| PyTorch    | 1.5.1             | `base-image-qyil80d3s4` | CUDA 10.1 · Ubuntu 18.04         |
| PyTorch    | 1.1.0             | `base-image-0x7zgbw1ji` | CUDA 10 · Ubuntu 18.04           |
| TensorFlow | 2.9.0             | `base-image-uxeklgirir` | CUDA 11.2 · Ubuntu 20.04         |
| TensorFlow | 2.5.0             | `base-image-0gxqmciyth` | CUDA 11.2 · Ubuntu 18.04         |
| TensorFlow | 1.15.5            | `base-image-4bpg0tt88l` | CUDA 11.4 · Ubuntu 20.04         |
| Miniconda  | —                 | `base-image-8hkyyugih5` | CUDA 11.8 · Ubuntu 22.04         |
| Miniconda  | —                 | `base-image-m26c71lgul` | CUDA 11.8 · Ubuntu 20.04         |
| Miniconda  | —                 | `base-image-mbr2n4urrc` | CUDA 11.6 · Ubuntu 20.04         |
| Miniconda  | —                 | `base-image-zsd8dwuwus` | CUDA 11.3(cudagl) · Ubuntu 20.04 |
| Miniconda  | —                 | `base-image-7bn8iqhkb5` | CUDA 11.3 · Ubuntu 18.04         |
| Miniconda  | —                 | `base-image-h041hn36yt` | CUDA 11.1 · Ubuntu 18.04         |
| Miniconda  | —                 | `base-image-hek323ev8b` | CUDA 10.1 · Ubuntu 18.04         |
| Miniconda  | —                 | `base-image-qkkhitpik5` | CUDA 10.2 · Ubuntu 18.04         |
| Miniconda  | —                 | `base-image-1e5uf433g1` | CUDA 10 · Ubuntu 18.04           |
| Miniconda  | —                 | `base-image-k0vep6kyq8` | CUDA 9 · Ubuntu 16.04            |
| Miniconda  | —                 | `base-image-b23jugu52k` | CUDA 8.0 · Ubuntu 22.04          |
| TensorRT   | 8.6.1             | `base-image-l2193iu12k` | CUDA 11.8 · Ubuntu 20.04         |
| TensorRT   | 8.5.1             | `base-image-l2843iu23k` | CUDA 11.8 · Ubuntu 20.04         |
