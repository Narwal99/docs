...
4. **If you are using a Notebook**, refer to the bottom of the JupyterLab [documentation](/cloud-container-instance/jupyterlab) for issues related to log updates after network disconnections.
