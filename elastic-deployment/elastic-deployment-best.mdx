...
Pre-installed Image → Create Instance → Configure Inference Environment → Save as Custom Image → Obtain Image ID → Store Model in File Storage → Create Elastic Deployment with My Images → Load Model from File Storage → Start Inference
