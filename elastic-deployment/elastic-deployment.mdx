...
<Note>
Elastic Deployment is designed for research institutions and enterprise teams that require managed, scalable GPU deployment for long-running AI workloads. This service is available by request only. If you would like to use Elastic Deployment, please contact us at support@gpuhub.com.
</Note>
...
<Columns cols={2}>
    ...
    href="/elastic-deployment/why-not-serverless"
    arrow="true"
    >
