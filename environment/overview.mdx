...
At present, GPUHub **DOES NOT support deploying containers using Docker image hosted on 3rd-party container registries**, including but not limited to Docker Hub, GitHub Container Registry, and GitLab Container Registry.
