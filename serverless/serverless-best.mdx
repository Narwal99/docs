---
title: Serverless Best Practice
...
![](../images/serveless-archi-dia.png)
...
**Reusing Containers**
In the process of using Serverless GPU deployments, the main time consumption is in pulling the image. Larger images and more simultaneously scheduled containers will have a greater impact on startup time. Therefore, to shorten container creation time, support for reusing stopped containers in Serverless GPU has been added.
