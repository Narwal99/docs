...
GPUhub will actively utilize technical means to monitor the content exposed by the customized service and cooperate with relevant telecommunications regulatory and law enforcement departments in their monitoring efforts. Upon discovering any illegal or non-compliant content in the customized service, GPUhub will immediately suspend the user's account and terminate the customized service. This action will not be considered a violation of the [GPUhub Terms of Service](/terms/terms-of-service). If suspicious illegal activities are detected, GPUhub has the right to report to the police and provide relevant data.
