...
They are located in different data centers. Just to clarify, there is no dedicated line between our data centers, so transfers between them won't be accelerated.