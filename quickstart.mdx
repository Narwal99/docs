...
For details, see [Instance Data Retention Policy](/data-trans-storage/overview).
</Note>
...
Refer to the [Instance Overview](cloud-container-instance/overview) for the data disk path.
</Tip>
...
For folder uploads or advanced methods, refer to the [Data Upload](data-trans-storage/upload-data) documentation.
