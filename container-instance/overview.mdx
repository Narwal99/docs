...
Important data should be regularly backed up to [file storage](/data/file-storage) or locally. 
...
|GPUhub File Storage	|/root/autodl-fs	|Free 20GB, billed for additional capacity	|Network disk, Moderate	|Enables file synchronization and sharing between different instances within the same region.|
