...
description: 'Only instances with Usage-based Pricing Model supports configuration adjustments.'
---

<Note>
For instances with Usage-based Pricing Model that are already powered on, if you need to increase or decrease the number of GPUs, you can use the scale configuration feature to adjust the instance's settings. For instances with Subscription Pricing Model, if you want to scale up or down, you will first need to switch to Usage-based Pricing Model before adjusting the configuration.
</Note>
