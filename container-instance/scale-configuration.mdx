...
description: 'Only instances with Usage-based Billing Mode supports configuration adjustments.'
---

<Note>
For instances with Usage-based Billing Mode that are already powered on, if you need to increase or decrease the number of GPUs, you can use the scale configuration feature to adjust the instance's settings. For instances with Subscription Billing Mode, if you want to scale up or down, you will first need to switch to Usage-based Billing Mode before adjusting the configuration.
</Note>
