...
you can switch from a Pay-as-you-go Mode to Subscription Mode (daily or weekly basis).
...
### Using 3rd-Party Cloud Drives Method
You can first upload the data from the source instance to a cloud disk, and then download the data from the cloud disk to the target instance. For instructions on using a cloud disk, please refer to the public [3rd-Party Cloud Drives documentation](/data/thirdparty-drives).
